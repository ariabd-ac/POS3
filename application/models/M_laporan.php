...
class M_laporan extends CI_Model
{
	...
	function get_data_jual_pertanggal_pagi($tanggal, $tanggal_akhir, $uid)
	{
		// $hsl = $this->db->query("SELECT jual_nofak,DATE_FORMAT(jual_tanggal,'%d %M %Y %H:%i:%s') AS jual_tanggal,d_jual_barang_id,d_jual_barang_nama,d_jual_barang_satuan,d_jual_barang_harpok,d_jual_barang_harjul,d_jual_qty,d_jual_diskon,d_jual_total FROM tbl_jual JOIN tbl_detail_jual ON jual_nofak=d_jual_nofak WHERE DATE(jual_tanggal)='$tanggal' ORDER BY jual_nofak DESC");
		// var_dump($tanggal);
		// die;
		$hsl = $this->db->query("SELECT jual_nofak,
															DATE_FORMAT(jual_tanggal,'%d-%m-%Y %H:%i:%s') 
																AS jual_tanggal,jual_user_id,d_jual_barang_id,d_jual_barang_nama,d_jual_barang_satuan,d_jual_barang_harpok,d_jual_barang_harjul,d_jual_qty,d_jual_diskon,d_jual_total 
																	FROM tbl_jual 
																		JOIN tbl_detail_jual ON jual_nofak=d_jual_nofak 
																			WHERE 
																				jual_tanggal >= '$tanggal' AND 
																				jual_tanggal <= '$tanggal_akhir' AND
																				jual_user_id = '$uid'
	...
	function get_data__total_jual_pertanggal_pagi($tanggal, $tanggal_akhir, $uid)
	{
		...
		$hsl = $this->db->query("SELECT jual_nofak,
															DATE_FORMAT(jual_tanggal,'%d %M %Y') 
																AS jual_tanggal,jual_user_id,d_jual_barang_id,d_jual_barang_nama,d_jual_barang_satuan,d_jual_barang_harpok,d_jual_barang_harjul,d_jual_qty,d_jual_diskon,
																	SUM(d_jual_total) 
																		as total 
